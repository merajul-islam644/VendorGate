...
export function UserMenu({ onNavigate }: { onNavigate: (path: string) => void }) {
  ...
  const name = userDisplayName(profile) || (me.isLoading ? t("common.userMenu.loading") : t("common.userMenu.guest"));
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="user-menu-trigger" aria-label={t("common.userMenu.open")}>
